...
# when printing text, it must be in speechmarks which turns iy
print("Hello")

# There are lots of different data type:
# integers, decimals (floating pont numbers)
...
print(name)
# To combine with a stiring, we use f-strings
# The variables goes inside curly brackets
